...
use App\AdventOfCode\Year2015\Day16;
...
class Day16Test extends TestCase
{
    ...
    {
        $testCases = [
            ['input' => new DefaultInput($this->actualInput), 'expected' => 40],
        ];

        foreach ($testCases as $n => $testCase) {
            $this->assertEquals($testCase['expected'], (new Day16())->part1($testCase['input']), "Testcase #$n");
        }
    }
    ...
    {
        $testCases = [
            ['input' => new DefaultInput($this->actualInput), 'expected' => 241],
        ];

        foreach ($testCases as $n => $testCase) {
            $this->assertEquals($testCase['expected'], (new Day16())->part2($testCase['input']), "Testcase #$n");
        }
    }

    private string $actualInput = 'Sue 1: goldfish: 9, cars: 0, samoyeds: 9

...
use Puzzles\AdventOfCode\Year2015\Day08;
...
class Day08Test extends TestCase
{
    public function testPart1()
    {
        ...
        foreach ($testCases as $n => $testCase) {
            $this->assertEquals($testCase['expected'], (new Day08())->part1($testCase['input']), "Testcase #{$n}");
        }
    }
    ...
    public function testPart2()
    {
        ...
        foreach ($testCases as $n => $testCase) {
            $this->assertEquals($testCase['expected'], (new Day08())->part2($testCase['input']), "Testcase #{$n}");
        }
    }

    private $testInputPart1 = '""
"abc"
"aaa\"aaa"
"\x27"';

    private $actualInput = '"\xa8br\x8bjr\""
"nq"

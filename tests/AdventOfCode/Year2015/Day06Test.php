...
use Puzzles\AdventOfCode\Year2015\Day06;
...
class Day06Test extends TestCase
{
    ...
    {
        $testCases = [
            ['input' => new DefaultInput('turn on 0,0 through 999,999'), 'expected' => 1000000],
            ['input' => new DefaultInput('toggle 0,0 through 999,0'), 'expected' => 1000],
            ['input' => new DefaultInput('turn off 499,499 through 500,500'), 'expected' => 0],
            ['input' => new DefaultInput($this->actualInput), 'expected' => 569999],
        ];
    ...
    {
        $testCases = [
            ['input' => new DefaultInput('turn on 0,0 through 0,0'), 'expected' => 1],
            ['input' => new DefaultInput('toggle 0,0 through 999,999'), 'expected' => 2000000],
            ['input' => new DefaultInput($this->actualInput), 'expected' => 17836115],
        ];
    ...
    private string $actualInput = 'turn on 489,959 through 759,964

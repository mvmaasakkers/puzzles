...
use App\AdventOfCode\Year2021\Day02;
...
class Day02Test extends TestCase
{
    public function testPart1(): void
    {
        $testCases = [
            [
                'input' => new DefaultInput('forward 5
down 5
forward 8
up 3
down 8
forward 2'),
            ...
            ['input' => new DefaultInput($this->actualInput), 'expected' => 1813801],
        ];
...
forward 2'),
            ...
            ['input' => new DefaultInput($this->actualInput), 'expected' => 1960569556],
        ];
    ...
    private string $actualInput = 'forward 8
forward 3
down 8
forward 4
down 2

...
use App\AdventOfCode\Year2016\Day04;
...
class Day04Test extends TestCase
{
    ...
    {
        $testCases = [
            ['input' => new DefaultInput('aaaaa-bbb-z-y-x-123[abxyz]
a-b-c-d-e-f-g-h-987[abcde]
not-a-real-room-404[oarel]
totally-real-room-200[decoy]'), 'expected' => 1514],
            ['input' => new DefaultInput($this->actualInput), 'expected' => 158835],
        ];
    ...
    {
        $testCases = [
            ['input' => new DefaultInput($this->actualInput), 'expected' => 993],
        ];
    ...
    private string $actualInput = 'nzydfxpc-rclop-qwzhpc-qtylyntyr-769[oshgk]

...
use App\AdventOfCode\Year2016\Day06;
...
vrdear
dvrsen
enarar'), 'expected' => 'easter'],
            ['input' => new DefaultInput($this->actualInput), 'expected' => 'kjxfwkdh'],
        ];
...
vrdear
dvrsen
enarar'), 'expected' => 'advent'],
            ['input' => new DefaultInput($this->actualInput), 'expected' => 'xrwcsnps'],
        ];
    ...
    private string $actualInput = 'hgxcejbh
xllyqcqh
wfbuksyy
gdfkgzny
jaswdllt

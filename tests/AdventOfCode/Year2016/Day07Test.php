...
use App\AdventOfCode\Year2016\Day07;
...
class Day07Test extends TestCase
{
    ...
    {
        $testCases = [
            ['input' => new DefaultInput('abba[mnop]qrst'), 'expected' => 1],
            ['input' => new DefaultInput('abcd[bddb]xyyx'), 'expected' => 0],
            ['input' => new DefaultInput('aaaa[qwer]tyui'), 'expected' => 0],
            ['input' => new DefaultInput('ioxxoj[asdfgh]zxcvbn'), 'expected' => 1],
            ['input' => new DefaultInput($this->actualInput), 'expected' => 118],
        ];
...
//            ['input' => new DefaultInput(''), 'expected' => 0],
    ...
    private string $actualInput = 'wysextplwqpvipxdv[srzvtwbfzqtspxnethm]syqbzgtboxxzpwr[kljvjjkjyojzrstfgrw]obdhcczonzvbfby[svotajtpttohxsh]cooktbyumlpxostt
